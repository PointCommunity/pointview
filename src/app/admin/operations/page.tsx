...
export default async function OperationsPage() {
  ...
  `;
  return <AppShell><section className="page-heading compact"><p className="eyebrow">Operations</p><h1>Daily triage health.</h1><p className="lede">The runner works oldest-first, one record at a time, and never initiates development.</p></section>
