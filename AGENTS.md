...
This version has breaking changes. Before writing Next.js code, read the relevant installed guide under `node_modules/next/dist/docs/`; heed deprecations. This block may be maintained by `next dev`.
